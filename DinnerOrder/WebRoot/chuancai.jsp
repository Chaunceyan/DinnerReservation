  ...
  <div class="main">
    ...
    <c:forEach items="${sessionScope.fourProducts}" var="product" begin="0" end="3">
			   	   <div class="col-md-3">
			   	   	<div class="content_box"><a href="single.html">
				   	   	 ...
				   	   	 <div class="content_box-grid">
				   	   	  <p class="m_1"><c:out value="${product.productsDescription }" escapeXml="true"></c:out></p>
				   	   	  <div class="price">Price:
						    <span class="actual">$<c:out value="${product.productsPrice}" escapeXml="true"></c:out></span>
			...
			<div class="row content_bottom1">
			   ...
			   <a href="servlet/ShowVegServlet?type=chuancai&pageIndex=1">首页</a>
			   <a href="servlet/ShowVegServlet?type=chuancai&pageIndex=${pageIndex-1}">上一页</a>
			   <a href="servlet/ShowVegServlet?type=chuancai&pageIndex=${pageIndex+1}">下一页</a>
			   <a href="servlet/ShowVegServlet?type=chuancai&pageIndex=${sessionScope.lastPage}">尾页</a>
