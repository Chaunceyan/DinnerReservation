...
<body>
	<div class="main">
		...
		<a href="servlet/ShowVegServlet?type=yuecai&pageIndex=1">首页</a> <a
			href="servlet/ShowVegServlet?type=yuecai&pageIndex=${pageIndex-1}">上一页</a>
		<a href="servlet/ShowVegServlet?type=yuecai&pageIndex=${pageIndex+1}">下一页</a>
		<a
			href="servlet/ShowVegServlet?type=yuecai&pageIndex=${sessionScope.lastPage}">尾页</a>
