<%@page
	import="com.order.dao.subsystem.ProductsDAO,com.order.bean.Products"%>
		...
		<div class="container">
			<div class="header_top">
				...
				<ul class="order">
					<c:choose>
						<c:when test="${sessionScope.isSignIn}">
							<li>欢迎 <c:out value="${sessionScope.cart.price}"></c:out></li>
						</c:when>
						<c:otherwise>
							<li>尚未登录</li>
						</c:otherwise>
				...
				<ul class="shopping_cart">
					...
					<li class="shop_right"><span>￥${sessionScope.customer.totalCost}</span></li> 
					<div class="clearfix"></div>
				</ul>
				<div class="clearfix"></div>
			</div>
				...
				<div class="row content">
					...
					<div class="col-md-9">
						<div class="breadcrumb">
							<a href="index.html">Home</a> &gt;&gt; <span class="last">Account/Login</span>
						</div>
